...
def remove_end_events_name(root):
	print("* Removing end events name...")
...
def post_process_json_file(input_json, output_json, call_depth, group_rank_events):
	...
	pretty_print(root)
	# Remove name of event for end events for compatibility with Perfetto
	remove_end_events_name(root)
